...
* [Using FusionCharts as an ESModules](#using-fusioncharts-as-an-es-module)
...
## Using FusionCharts as an ESModules
FusionCharts can be loaded as an ESModules via transpilers.
